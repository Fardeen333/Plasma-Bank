...
import com.example.plasmabank1.Utils.Endpoints;
import com.example.plasmabank1.Utils.VolleySingleton;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void register(final String name, final String city, final String blood_group, final String password, final String mobile){
